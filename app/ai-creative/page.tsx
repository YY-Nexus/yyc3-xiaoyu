...
import { type ArtStyle, type StoryStyle, ART_STYLE_CONFIG, STORY_STYLE_CONFIG } from "@/types/ai-creative"
...
export default function AICreativePage() {
  ...
  const [continuationOptions, setContinuationOptions] = useState<any[]>([])
  ...
  // 选择续写方向
  const handleSelectOption = (storyId: string, option: any) => {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden relative bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      <PageHeader
              ...
              >
                ...
                <div className="bg-white rounded-3xl p-6 shadow-lg">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {[
                      { ratio: "1:1", icon: "ri-checkbox-blank-line", label: "正方形" },
                      { ratio: "4:3", icon: "ri-landscape-line", label: "横向" },
                      { ratio: "3:4", icon: "ri-portrait-line", label: "竖向" },
                      { ratio: "16:9", icon: "ri-computer-line", label: "宽屏" },
                    ].map((item) => (
                      <motion.button
                        key={item.ratio}
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-3">
                            <button
                              ...
                              className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-bold disabled:opacity-50"
                            >
